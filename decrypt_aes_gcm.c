...
int main(int argc, char *argv[], char *envp[]) {
	...
	const EVP_CIPHER *aes_256_gcm	 = EVP_aes_256_gcm();
	const EVP_CIPHER *aes_128_gcm	 = EVP_aes_128_gcm();
	...
	int res = aes_encrypt(plaintext, 16, type, key, NULL, ciphertext);
	...
	int res2 = aes_decrypt(ciphertext, res, type, key, NULL, cleartext);
	...
	int res3 = aes_gcm_decrypt(secret, SECRET_LENGTH, aes_128_gcm, aad, AAD_LENGTH, atag, ppkey, iv, IV_LENGTH, decoded_msg);
